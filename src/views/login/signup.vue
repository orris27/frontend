  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="licenseId">
        ...
        <el-input v-model="loginForm.licenseId" name="licenseId" type="text" auto-complete="on" placeholder="driving license id" />
      </el-form-item>
      <el-form-item prop="contact">
        <span class="svg-container">
          <svg-icon icon-class="message" />
        </span>
        <el-input v-model="loginForm.contact" name="contact" type="text" auto-complete="on" placeholder="contact" />
      </el-form-item>
